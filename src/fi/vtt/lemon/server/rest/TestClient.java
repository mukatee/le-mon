...
import fi.vtt.lemon.server.rest.resources.BaseMeasure;
import fi.vtt.lemon.server.rest.resources.ClientRequest;
import fi.vtt.lemon.server.rest.resources.FrameworkInfo;
import fi.vtt.lemon.server.rest.resources.HistoryRequest;
import fi.vtt.lemon.server.rest.resources.MeasurementHistory;
import fi.vtt.lemon.server.rest.resources.MeasurementValue;
import fi.vtt.lemon.server.rest.resources.Parameter;
import fi.vtt.lemon.server.rest.resources.Probe;
import fi.vtt.lemon.server.rest.resources.ProbeConfiguration;
import fi.vtt.lemon.server.rest.resources.ProbesInfo;
import fi.vtt.lemon.server.rest.resources.Session;
import fi.vtt.lemon.server.rest.resources.Target;
