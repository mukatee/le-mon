...
package fi.vtt.noen.mfw.bundle.server.webui.subscribetobmpage;

import osmo.common.log.Logger;
import fi.vtt.noen.mfw.bundle.server.webui.WebUIPlugin;
import fi.vtt.noen.mfw.bundle.server.webui.availabilitypage.BMDesc;
import fi.vtt.noen.mfw.bundle.server.webui.availabilitypage.BMListDataProvider;
import fi.vtt.noen.mfw.bundle.server.webui.mfwclient.Availability;
import fi.vtt.noen.mfw.bundle.server.webui.mfwclient.BM;
