...
import fi.vtt.noen.mfw.bundle.server.rest.resources.BaseMeasure;
import fi.vtt.noen.mfw.bundle.server.rest.resources.ClientRequest;
import fi.vtt.noen.mfw.bundle.server.rest.resources.FrameworkInfo;
import fi.vtt.noen.mfw.bundle.server.rest.resources.HistoryRequest;
import fi.vtt.noen.mfw.bundle.server.rest.resources.MeasurementHistory;
import fi.vtt.noen.mfw.bundle.server.rest.resources.MeasurementValue;
import fi.vtt.noen.mfw.bundle.server.rest.resources.Parameter;
import fi.vtt.noen.mfw.bundle.server.rest.resources.Probe;
import fi.vtt.noen.mfw.bundle.server.rest.resources.ProbeConfiguration;
import fi.vtt.noen.mfw.bundle.server.rest.resources.ProbesInfo;
import fi.vtt.noen.mfw.bundle.server.rest.resources.Session;
import fi.vtt.noen.mfw.bundle.server.rest.resources.Target;
