...
import fi.vtt.lemon.server.derivedmeasure.DMProcessingException;
import fi.vtt.lemon.server.derivedmeasure.DMProcessor;
...
public class DMTests {
  ...
  public void scriptCreationWithMissingValues() throws Exception {
    ...
    DMProcessor processor = new DMProcessor(dm);
